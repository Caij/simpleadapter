...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public InOnClickListener mInOnClickListener;
    ...
    public BaseViewHolder(View itemView)
    {
        ...
        mInOnClickListener = new InOnClickListener(this);
    }
    ...
    public static class InOnClickListener implements View.OnClickListener, View.OnLongClickListener  {
        ...
        public InOnClickListener(RecyclerView.ViewHolder viewHolder) {
            mViewHolder = viewHolder;
        }

        public void setCanNoAttachClick(boolean canNoAttachClick) {
            isCanNoAttachClick = canNoAttachClick;
        }
        ...
        public void onClick(View v) {
            if (mViewHolder.getAdapterPosition() != RecyclerView.NO_POSITION || isCanNoAttachClick) {
                if (v == mViewHolder.itemView) {
                    mOnItemClickListener.onItemClick(mViewHolder, v, mViewHolder.getAdapterPosition());
                } else {
                    if (mOnItemPartViewClickListener != null) {
                        mOnItemPartViewClickListener.onPartViewClick(v, mViewHolder.getAdapterPosition());
                    }
                }
            }
        }
